 ...
 * @author x15007707
 */
public class LottoGameGUI extends javax.swing.JFrame {
...
// TODO add your handling code here: 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LottoGameGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LottoGameGUI().setVisible(true);
            }
        });
    }
